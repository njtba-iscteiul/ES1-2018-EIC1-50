...
//		userInfo.append("Twitter: \n");
	...
	private void emailPanel() {
		...
		btnSend.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showOptionDialog(null, "Email successfully sent", "Email", JOptionPane.YES_NO_CANCEL_OPTION,
	...
	protected void checkPassword(JPanel atualPanel) {
